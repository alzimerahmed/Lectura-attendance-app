...
## What it is
Android attendance tracker (formerly Lumera, cloned from agupta07505/Lumera, now owned by alzimer ahmed). Package: `com.alzimerahmed.lumera`. Repo: github.com/alzimerahmed/Lumera-attendance-app.
...
## Structure
- `data/` Room entities (Subject, TimetableEntry, AttendanceSession, AttendanceUnit, Holiday), DAOs, `LumeraRepository`, DataStore prefs, `data/remote/gemini/TimetableOcrService`
...
- Deleted: old tags, Lumera.jks/base64, metadata.json, .idea, 5W2H.md, ROADMAP.md, all .md except README + LICENSE
...
- Pending: implementation plan for idea.md items; app rename Lumera → Lumera; README refresh
