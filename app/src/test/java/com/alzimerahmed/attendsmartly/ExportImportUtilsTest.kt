...
import com.alzimerahmed.attendsmartly.util.ExportImportUtils
...
class ExportImportUtilsTest {
    ...
    fun testSanitizeHolidayWithNulls() {
        ...
        val gson = Gson()
        val deserialized = gson.fromJson(rawJson, com.alzimerahmed.attendsmartly.data.local.entity.HolidayEntity::class.java)
    ...
    fun testV12BackupWithMissingFieldsAndNullsDeserialization() {
        ...
        val parsedHolidays = ExportImportUtils.parseJsonArray(holidaysJson, com.alzimerahmed.attendsmartly.data.local.entity.HolidayEntity::class.java)
    ...
    fun testFullBackupRoundTripSerialization() {
        ...
        val holiday = com.alzimerahmed.attendsmartly.data.local.entity.HolidayEntity(id = 50, date = "2026-08-15", title = "Independence Day")

        val backup = com.alzimerahmed.attendsmartly.util.AttendSmartlyBackup(
            version = 1,
        ...
        val deserialized = gson.fromJson(json, com.alzimerahmed.attendsmartly.util.AttendSmartlyBackup::class.java)
    ...
    fun testImportActualHelperBackupFile() {
        ...
        if (backupFile.exists()) {
            ...
            val gson = Gson()
            val backup = gson.fromJson(jsonContent, com.alzimerahmed.attendsmartly.util.AttendSmartlyBackup::class.java)
