...
class ExportImportUtilsTest {
    ...
    fun testSanitizeHolidayWithNulls() {
        ...
        val gson = Gson()
        val deserialized = gson.fromJson(rawJson, com.alzimerahmed.lumera.data.local.entity.HolidayEntity::class.java)
    ...
    fun testV12BackupWithMissingFieldsAndNullsDeserialization() {
        ...
        val parsedHolidays = ExportImportUtils.parseJsonArray(holidaysJson, com.alzimerahmed.lumera.data.local.entity.HolidayEntity::class.java)
    ...
    fun testFullBackupRoundTripSerialization() {
        ...
        val holiday = com.alzimerahmed.lumera.data.local.entity.HolidayEntity(id = 50, date = "2026-08-15", title = "Independence Day")

        val backup = com.alzimerahmed.lumera.util.LumeraBackup(
            version = 1,
        ...
        val deserialized = gson.fromJson(json, com.alzimerahmed.lumera.util.LumeraBackup::class.java)
    ...
    fun testImportActualHelperBackupFile() {
        val backupFile = java.io.File("A:\\Lumera\\helper\\Lumera_backup.json")
        if (backupFile.exists()) {
            val jsonContent = backupFile.readText()
            val gson = Gson()
            val backup = gson.fromJson(jsonContent, com.alzimerahmed.lumera.util.LumeraBackup::class.java)
