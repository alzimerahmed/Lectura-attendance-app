...
package com.alzimerahmed.attendsmartly.util
...
object GitHubUpdateChecker {
    ...
    private const val GITHUB_API_LATEST_RELEASE = "https://api.github.com/repos/alzimerahmed84/AttendSmartly/releases/latest"
    ...
    suspend fun checkForUpdates(currentVersion: String): Result<GitHubReleaseInfo?> = withContext(Dispatchers.IO) {
        try {
            ...
            httpClient.newCall(request).execute().use { response ->
                ...
                val htmlUrl = json.get("html_url")?.asString ?: "https://github.com/alzimerahmed84/AttendSmartly/releases"
