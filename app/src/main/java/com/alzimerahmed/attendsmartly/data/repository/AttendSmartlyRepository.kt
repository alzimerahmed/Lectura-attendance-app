...
package com.alzimerahmed.attendsmartly.data.repository
...
import com.alzimerahmed.attendsmartly.data.local.entity.*
...
class AttendSmartlyRepository(
    ...
    suspend fun updateTimetableEntry(entry: TimetableEntryEntity) {
        ...
        if (oldEntry != null) {
            ...
            for (session in linkedSessions) {
                ...
                val isMarked = sessionUnits.any { it.status != com.alzimerahmed.attendsmartly.domain.model.AttendanceStatus.UNMARKED.name }
    ...
    suspend fun updateTimetableEntryFromDate(
        ...
        if (oldEntry != null) {
            ...
            val hasPastMarkedSessions = pastSessions.any { session ->
                ...
                attendanceDao.getUnitsForSession(session.id).any { it.status != com.alzimerahmed.attendsmartly.domain.model.AttendanceStatus.UNMARKED.name }
            }
    ...
    suspend fun importParsedTimetable(
        items: List<com.alzimerahmed.attendsmartly.domain.model.ParsedTimetableItem>,
